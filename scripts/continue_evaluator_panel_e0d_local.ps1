...
$runner = "scripts/run_evaluator_panel_external_calibration_e0d.py"
$contract = "configs/evaluator_panel/external_calibration_e0d.json"
$ministralSummary = "data/evaluator_panel_v2/e0d_ministral_judge_execution.safe.json"
$gaScreen = "data/evaluator_panel_v2/e0d_ga_screen.safe.json"
