...
$contract = "configs/evaluator_panel/external_calibration_e0d_v1_1.json"
$ministralSummary = "data/evaluator_panel_v2/e0d_v1_1_ministral_judge_execution.safe.json"
$gaScreen = "data/evaluator_panel_v2/e0d_v1_1_ga_screen.safe.json"
